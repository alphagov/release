module UrlHelper
  ...
  def argo_app_link_to(app, environment)
    link_to(environment, "https://argo.eks.#{environment}.govuk.digital/applications/#{app.downcase}", target: "_blank", rel: "noreferrer", class: "govuk-link")
  end
end
