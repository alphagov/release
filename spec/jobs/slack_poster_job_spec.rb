RSpec.describe SlackPosterJob, type: :job do
  ...
  describe "#perform" do
    ...
    xit "raises error when called with invalid options" do
      expect {
        described_class.perform_now(
          "Hello",
          "#testchannel",
          { "name" => "Slack poster", "icon_emoji" => ":badger:" },
        )
      }.to raise_error(StandardError, /Invalid options, only username, icon_emoji, mrkdown are permitted/)
    end
  end
end
